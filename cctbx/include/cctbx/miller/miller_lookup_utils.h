...
#ifndef CCTBX_MILLER_MILLER_LOOKUP_UTILS_H
#define CCTBX_MILLER_MILLER_LOOKUP_UTILS_H
...
namespace miller_lookup_utils{


  template <typename FloatType=double>
  class miller_index_lookup_tensor
  {
  ...
  class local_neighbourhood
  {
    ...
    protected:
    miller_lookup_utils::miller_index_lookup_tensor<FloatType>
      lookup_tensor_;
  ...
  template <typename FloatType = double >
  class local_area_with_property
  {
    public:
    local_area_with_property(){}
    local_area_with_property(
               scitbx::af::const_ref< cctbx::miller::index<> > const& hkl,
...
}}} // namespace cctbx::miller::miller_lookup_utils
#endif // CCTBX_MILLER_MILLER_LOOKUP_UTILS_H
