...
def show_map(unit_cell, map_covering_unit_cell, label):
  ...
  cmd.isomesh(label+"_con", label+"_cell", 3.0) # create mesh
...
def show_fft():
  ...
  show_map(fft_map.unit_cell(), fft_map.real_map(), "fft_map")
