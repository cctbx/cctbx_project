...
def verify_hl(sg_miller_index_set, sg_hl, p1_miller_indices, p1_hl):
...
def write_cns_input(miller_index_set, hl):
...
def exercise(SgInfo, d_min=2., friedel_flag=0, verbose=0):
  ...
  verify_hl(sg_miller_index_set, sg_hl, p1_miller_indices, p1_hl)
