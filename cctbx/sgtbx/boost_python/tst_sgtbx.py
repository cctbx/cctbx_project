...
def exercise_direct_space_asu():
  cp = sgtbx.direct_space_asu.float_cut_plane(n=[-1,0,0], c=1)
  ...
  for i in xrange(3):
    n = [0,0,0]
    n[i] = -1
    facets.append(sgtbx.direct_space_asu.float_cut_plane(n=n, c=i+1))
  asu = sgtbx.direct_space_asu.float_asu(
    unit_cell=unit_cell,
    facets=facets,
  ...
  asu = sgtbx.direct_space_asu.float_asu(
    unit_cell=unit_cell,
    facets=[sgtbx.direct_space_asu.float_cut_plane(n=n,c=c) for n,c in [
      [(0, 0, 1), -1/2.],
      [(-1, -1, 0), 1],
      [(0, 1, -1), 3/4.],
      [(1, 0, -1), 1/4.]]])
