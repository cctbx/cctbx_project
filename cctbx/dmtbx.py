...
ext = boost_adaptbx.python.import_ext("cctbx_dmtbx_ext")
from cctbx_dmtbx_ext import *

@boost_adaptbx.python.inject_into(weighted_triplet_phase_relation)
class _():
...
@boost_adaptbx.python.inject_into(ext.triplet_generator)
class _():
