...
def exercise_triplet_generator():
  ...
  a = flex.double((1,2))
  t = dmtbx.ext.triplet_generator(sg, i)
  t = dmtbx.ext.triplet_generator(sg, i, 00000)
  t = dmtbx.ext.triplet_generator(sg, i, 00000, 00000)
  assert t.t_den() == sg.t_den()
  assert t.sigma_2_only() == 00000
  assert t.discard_weights() == 00000
  t = dmtbx.ext.triplet_generator(sg, i, 0001, 00000)
  assert t.sigma_2_only() == 0001
  assert t.discard_weights() == 00000
  t = dmtbx.ext.triplet_generator(sg, i, 00000, 0001)
  assert t.sigma_2_only() == 00000
  ...
  s = flex.bool()
  r = t.raw_apply_tangent_formula(a, a, s, 00000, 00000, 1.e-15)
