...
\end{align}
That demonstrates \eqnref{minimalvarianceweights} and since weights differing by a common proportionality factor yields the same $\omega_i$, QED.
