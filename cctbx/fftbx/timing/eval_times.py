...
for idCode, data_list in idCodes.items():
  ...
  t_fftbx = data_list[3].time - data_list[2].time
  mega_byte = data_list[0].memory / (1024. * 1024)
  if (t_fftw < 0 or t_fftbx < 0):
    print "#", idCode, mega_byte, t_fftw, t_fftbx
  else:
    print idCode, mega_byte, t_fftw, t_fftbx, t_fftbx/t_fftw
