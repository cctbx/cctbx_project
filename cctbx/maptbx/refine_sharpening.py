...
def calculate_fsc(si=None,
  ...
  for sthol2,scale,rms_fo,cc,rms_fc in zip(
     ...
     print("d_min: %5.1f   scale:  %5.2f  rms Fo:  %7.1f rmsFc: %7.1f CC: %7.3f" %(
       0.5/sthol2**0.5,scale,rms_fo,rms_fc,cc), file=out)
...
class analyze_aniso_object(object):
  def __init__(self):
