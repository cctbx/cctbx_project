...
bool write_png (const char* file_name, int width, int height)
{
  ...
  // moved before setjmp hoping that this ensures correct cleanup
  ...
  if (setjmp(png_jmpbuf(png_ptr))) {
    // any png error generated by the png calls below will wind up here
    png_destroy_write_struct(&png_ptr, &info_ptr);
    throw std::runtime_error("Error in PNG library call.");
  }
