...
ext = boost_adaptbx.python.import_ext("smtbx_refinement_least_squares_ext")
...
@boost_adaptbx.python.inject_into(ext.mainstream_shelx_weighting)
class _():
...
@boost_adaptbx.python.inject_into(ext.unit_weighting)
class _():
...
@boost_adaptbx.python.inject_into(ext.sigma_weighting)
class _():
