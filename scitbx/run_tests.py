...
def run():
  ...
  "$D/rigid_body/free_motion_reference_impl.py",
  "$D/rigid_body/tst_featherstone.py",
  "$D/rigid_body/tst_free_motion.py",
  "$D/rigid_body/tst_free_motion_hard.py",
  "$D/rigid_body/tst_joint_lib.py",
  "$D/rigid_body/tst_singular.py",
  "$D/rigid_body/tst_spherical_refinement.py",
