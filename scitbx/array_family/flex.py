...
import boost_adaptbx.std_pair # import dependency
...
@boost_adaptbx.python.inject_into(grid)
class _():
...
@boost_adaptbx.python.inject_into(ext.min_max_mean_double)
class _():
...
@boost_adaptbx.python.inject_into(mersenne_twister)
class _():
...
@boost_adaptbx.python.inject_into(ext.linear_regression_core)
class _():
...
@boost_adaptbx.python.inject_into(ext.double)
class _():
...
@boost_adaptbx.python.inject_into(ext.linear_correlation)
class _():
...
@boost_adaptbx.python.inject_into(ext.weighted_histogram)
class _():
