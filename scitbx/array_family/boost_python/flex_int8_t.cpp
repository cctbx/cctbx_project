...
namespace scitbx { namespace af { namespace boost_python {
  ...
  flex<int8_t>::type*
  __8from_std_string(const_ref<std::string> const& s)
  {
    shared<int8_t> result(reserve(s.size()));
    for(std::size_t i=0;i<s.size();i++) {
      ...
      int8_t value = 0;
      try {
        value = boost::lexical_cast<int8_t>(s[i]);
      }
    ...
    return new flex<int8_t>::type(result, result.size());
  }

  shared<bool>
  as_bool(const_ref<int8_t> const& self, bool strict=true)
  {
  ...
  as_long(
    af::const_ref<int8_t, af::flex_grid<> > const& O)
  {
  ...
  as_string(
    af::const_ref<int8_t, af::flex_grid<> > const& O,
    std::string format_string="%+" PRId8)
  {
    std::size_t n = O.accessor().size_1d();
  ...
  af::shared<int8_t> bitwise_not(
      af::const_ref<int8_t> const &self) {
    af::shared<int8_t> result(self.size());
    for (std::size_t i = 0; i < self.size(); ++i) {
      result[i] = ~self[i];
    }
    return result;
  ...
  af::shared<int8_t> bitwise_or_single(
      af::const_ref<int8_t> const &self,
      int8_t other) {
    af::shared<int8_t> result(self.size());
    for (std::size_t i = 0; i < self.size(); ++i) {
  ...
  af::shared<int8_t> bitwise_or_array(
      af::const_ref<int8_t> const &self,
      af::const_ref<int8_t> const &other) {
  ...
  af::shared<int8_t> bitwise_and_single(
      af::const_ref<int8_t> const &self,
      int8_t other) {
    af::shared<int8_t> result(self.size());
    for (std::size_t i = 0; i < self.size(); ++i) {
  ...
  af::shared<int8_t> bitwise_and_array(
      af::const_ref<int8_t> const &self,
      af::const_ref<int8_t> const &other) {
    SCITBX_ASSERT(self.size() == other.size());
    af::shared<int8_t> result(self.size());
  ...
  af::shared<int8_t> bitwise_xor_single(
      af::const_ref<int8_t> const &self,
      int8_t other) {
    af::shared<int8_t> result(self.size());
    for (std::size_t i = 0; i < self.size(); ++i) {
  ...
  af::shared<int8_t> bitwise_xor_array(
      af::const_ref<int8_t> const &self,
      af::const_ref<int8_t> const &other) {
    SCITBX_ASSERT(self.size() == other.size());
    af::shared<int8_t> result(self.size());
  ...
  void wrap_flex_int8_t()
  {
    ...
    flex_wrapper<int8_t>::signed_integer("int8", scope())
      .def_pickle(flex_pickle_single_buffered<int8_t>())
      .def("__init__", make_constructor(
        __8from_std_string, default_call_policies()))
      .def("__init__", make_constructor(
        flex_int8_from_numpy_array, default_call_policies()))
      .def("copy_to_byte_str", copy_to_byte_str<versa<int8_t, flex_grid<> > >)
      .def("slice_to_byte_str",
        slice_to_byte_str<versa<int8_t, flex_grid<> > >)
      ...
      .def("as_rgb_scale_string", as_rgb_scale_string, (
        ...
        arg("rgb_scales_high"),
        arg("saturation")))
      .def("counts", counts<int8_t, std::map<long, long> >::unlimited)
      .def("counts", counts<int8_t, std::map<long, long> >::limited, (
        arg("max_keys")))
      .def("matrix_is_symmetric",
        (bool(*)(
          const_ref<int8_t, c_grid<2> > const&))
            matrix::is_symmetric)
      .def("matrix_copy_block",
        (versa<int8_t, c_grid<2> >(*)(
          const_ref<int8_t, c_grid<2> > const&,
      ...
      .def("matrix_transpose_in_place",
        (void(*)(versa<int8_t, flex_grid<> >&)) matrix_transpose_in_place)
      .def("matrix_rot90",
        (versa<int8_t, c_grid<2> >(*)(
           const_ref<int8_t, c_grid<2> > const&, int)) matrix_rot90)
      .def("matrix_swap_rows_in_place",
        (void(*)(
          ref<int8_t, c_grid<2> > const&, unsigned, unsigned))
        ...
        (void(*)(
          ...
          unsigned, unsigned))
            matrix::paste_block_in_place, (
              ...
              arg("i_row"),
              arg("i_column")))
      .def("as_numpy_array", flex_int8_as_numpy_array, (
        arg("optional")=false))
