...
namespace scitbx { namespace af { namespace boost_python {
  ...
  flex<int16_t>::type*
  __16from_std_string(const_ref<std::string> const& s)
  {
    shared<int16_t> result(reserve(s.size()));
    for(std::size_t i=0;i<s.size();i++) {
      ...
      int16_t value = 0;
      try {
        value = boost::lexical_cast<int16_t>(s[i]);
      }
    ...
    return new flex<int16_t>::type(result, result.size());
  }

  shared<bool>
  as_bool(const_ref<int16_t> const& self, bool strict=true)
  {
  ...
  af::shared<int16_t> bitwise_not(
      af::const_ref<int16_t> const &self) {
    af::shared<int16_t> result(self.size());
    for (std::size_t i = 0; i < self.size(); ++i) {
      result[i] = ~self[i];
    }
    return result;
  ...
  af::shared<int16_t> bitwise_or_single(
      af::const_ref<int16_t> const &self,
      int16_t other) {
    af::shared<int16_t> result(self.size());
    for (std::size_t i = 0; i < self.size(); ++i) {
  ...
  af::shared<int16_t> bitwise_or_array(
      af::const_ref<int16_t> const &self,
      af::const_ref<int16_t> const &other) {
  ...
  af::shared<int16_t> bitwise_and_single(
      af::const_ref<int16_t> const &self,
      int16_t other) {
    af::shared<int16_t> result(self.size());
    for (std::size_t i = 0; i < self.size(); ++i) {
  ...
  af::shared<int16_t> bitwise_and_array(
      af::const_ref<int16_t> const &self,
      af::const_ref<int16_t> const &other) {
    SCITBX_ASSERT(self.size() == other.size());
    af::shared<int16_t> result(self.size());
  ...
  af::shared<int16_t> bitwise_xor_single(
      af::const_ref<int16_t> const &self,
      int16_t other) {
    af::shared<int16_t> result(self.size());
    for (std::size_t i = 0; i < self.size(); ++i) {
  ...
  af::shared<int16_t> bitwise_xor_array(
      af::const_ref<int16_t> const &self,
      af::const_ref<int16_t> const &other) {
    SCITBX_ASSERT(self.size() == other.size());
    af::shared<int16_t> result(self.size());
  ...
  void wrap_flex_int16_t()
  {
    ...
    flex_wrapper<int16_t>::signed_integer("int16", scope())
      .def_pickle(flex_pickle_single_buffered<int16_t>())
      .def("__init__", make_constructor(
        __16from_std_string, default_call_policies()))
      .def("__init__", make_constructor(
        flex_int16_from_numpy_array, default_call_policies()))
      .def("copy_to_byte_str", copy_to_byte_str<versa<int16_t, flex_grid<> > >)
      .def("slice_to_byte_str",
        slice_to_byte_str<versa<int16_t, flex_grid<> > >)
      ...
      .def("as_rgb_scale_string", as_rgb_scale_string, (
        ...
        arg("rgb_scales_high"),
        arg("saturation")))
      .def("counts", counts<int16_t, std::map<long, long> >::unlimited)
      .def("counts", counts<int16_t, std::map<long, long> >::limited, (
        arg("max_keys")))
      .def("matrix_is_symmetric",
        (bool(*)(
          const_ref<int16_t, c_grid<2> > const&))
            matrix::is_symmetric)
      .def("matrix_copy_block",
        (versa<int16_t, c_grid<2> >(*)(
          const_ref<int16_t, c_grid<2> > const&,
      ...
      .def("matrix_transpose_in_place",
        (void(*)(versa<int16_t, flex_grid<> >&)) matrix_transpose_in_place)
      .def("matrix_rot90",
        (versa<int16_t, c_grid<2> >(*)(
           const_ref<int16_t, c_grid<2> > const&, int)) matrix_rot90)
      .def("matrix_swap_rows_in_place",
        (void(*)(
          ref<int16_t, c_grid<2> > const&, unsigned, unsigned))
        ...
        (void(*)(
          ...
          unsigned, unsigned))
            matrix::paste_block_in_place, (
              ...
              arg("i_row"),
              arg("i_column")))
      .def("as_numpy_array", flex_int16_as_numpy_array, (
        arg("optional")=false))
