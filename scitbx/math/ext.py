...
ext = boost_adaptbx.python.import_ext("scitbx_math_ext")
from scitbx_math_ext import *

import sys

@boost_adaptbx.python.inject_into(ext.basic_statistics)
class _():
...
@boost_adaptbx.python.inject_into(ext.line_search_more_thuente_1994)
class _():
...
@boost_adaptbx.python.inject_into(ext.unimodular_generator)
class _():
