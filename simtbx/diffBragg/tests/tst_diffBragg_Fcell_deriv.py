...
D = SIM.D
#idx, data = D.Fhkl_tuple
#data = flex.double(len(data), Fcell)
#D.Fhkl_tuple = idx, data
...
for i_shift, percent_shift in enumerate(shifts):
    ...
    #        plt.clf()
    #        plt.subplot(121)
    #        plt.imshow(finite_second_deriv, vmin=0, vmax=0.02)
    #        plt.title("finite second diff")
    #        plt.subplot(122)
    #        plt.imshow(second_deriv, vmin=0, vmax=0.02)
