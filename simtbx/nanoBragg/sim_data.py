...
class SimData:
    ...
    def instantiate_nanoBragg(self, verbose=0, oversample=0, device_Id=0, adc_offset=0, default_F=1000.0, interpolate=0):
        ...
        mosaic_vol_mm3 = self.D.xtal_size_mm[0] * self.D.xtal_size_mm[1] * self.D.xtal_size_mm[2]
        spot_scale = determine_spot_scale(self.beam.size_mm, self.crystal.thick_mm, mosaic_vol_mm3)
        assert spot_scale == self.D.spot_scale
