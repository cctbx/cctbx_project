...
//	int cu_hkls = hkls;
	...
	CUDA_CHECK_RETURN(hipMemcpy(cu_sdet_vector, _temp, NN, hipMemcpyHostToDevice));
	...
	CUDA_CHECK_RETURN(hipMemcpy(cu_fdet_vector, _temp, NN, hipMemcpyHostToDevice));
	...
	CUDA_CHECK_RETURN(hipMemcpy(cu_odet_vector, _temp, NN, hipMemcpyHostToDevice));
	...
	CUDA_CHECK_RETURN(hipMemcpy(cu_pix0_vector, _temp, NN, hipMemcpyHostToDevice));
	...
	CUDA_CHECK_RETURN(hipMemcpy(cu_beam_vector, _temp, NN, hipMemcpyHostToDevice));
	...
	CUDA_CHECK_RETURN(hipMemcpy(cu_spindle_vector, _temp, NN, hipMemcpyHostToDevice));

	CUDAREAL * cu_a0;
	CUDA_CHECK_RETURN(hipMalloc((void ** )&cu_a0, sizeof(*cu_a0) * vector_length));
	for(size_t i=0; i < vector_length; i++)
	    _temp[i] = a0[i];
	CUDA_CHECK_RETURN(hipMemcpy(cu_a0, _temp, NN, hipMemcpyHostToDevice));

	CUDAREAL * cu_b0;
	CUDA_CHECK_RETURN(hipMalloc((void ** )&cu_b0, sizeof(*cu_b0) * vector_length));
	for(size_t i=0; i < vector_length; i++)
	    _temp[i] = b0[i];
	CUDA_CHECK_RETURN(hipMemcpy(cu_b0, _temp, NN, hipMemcpyHostToDevice));

	CUDAREAL * cu_c0;
	CUDA_CHECK_RETURN(hipMalloc((void ** )&cu_c0, sizeof(*cu_c0) * vector_length));
	for(size_t i=0; i < vector_length; i++)
	    _temp[i] = c0[i];
	CUDA_CHECK_RETURN(hipMemcpy(cu_c0, _temp, NN, hipMemcpyHostToDevice));
	...
	CUDA_CHECK_RETURN(hipMemcpy(cu_polar_vector, _temp, NN, hipMemcpyHostToDevice));
	...
	CUDA_CHECK_RETURN(hipMemcpy(cu_source_lambda, source_temp, sourcesNN, hipMemcpyHostToDevice));
	...
	CUDA_CHECK_RETURN(hipMemcpy(cu_mosaic_umats, mos_temp, mosNN, hipMemcpyHostToDevice));
...
//	CUDA_CHECK_RETURN(hipFuncSetCacheConfig(reinterpret_cast<const void*>(reinterpret_cast<const void*>(nanoBraggSpotsCUDAKernel)), hipFuncCachePreferShared));
//	CUDA_CHECK_RETURN(hipFuncSetCacheConfig(reinterpret_cast<const void*>(reinterpret_cast<const void*>(nanoBraggSpotsCUDAKernel)), hipFuncCachePreferL1));
