...
db_tst_list = [
    ...
    ["$D/diffBragg/tests/tst_diffBragg_hopper_refine.py", "--perturb crystal --noNabcScale"],
    ["$D/diffBragg/tests/tst_diffBragg_hopper_refine.py", "--perturb Nabc --noNabcScale"],
    ["$D/diffBragg/tests/tst_diffBragg_hopper_refine.py", "--perturb G --noNabcScale"],
    ["$D/diffBragg/tests/tst_diffBragg_hopper_refine.py", "--perturb detz_shift --noNabcScale"],
    ["$D/diffBragg/tests/tst_diffBragg_hopper_refine.py", "--perturb crystal Nabc G --noNabcScale"],
    ["$D/diffBragg/tests/tst_diffBragg_hopper_refine.py", "--perturb crystal Nabc G detz_shift --noNabcScale"],
    ["$D/diffBragg/tests/tst_diffBragg_hopper_refine.py", "--perturb Nabc G --noNabcScale"],
    ["$D/diffBragg/tests/tst_diffBragg_hopper_refine.py", "--perturb spec --noNabcScale"],
