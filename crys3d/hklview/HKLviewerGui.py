...
#
# Created: Thu Feb 13 18:30:54 2020
...
class Ui_MainWindow(object):
  ...
  def retranslateUi(self, MainWindow):
    ...
    self.DrawReciprocUnitCellBox.setToolTip(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p>The reciprocal unit cell spanning a*,b*,c* from (0,0,0) to (1,1,1) is located in the centre of the displayed reflections. and therefore very small. Adjust the slider to resize its outline to become compatible with the sphere of displayed reflections.</p></body></html>", None, -1))
    ...
    self.DrawRealUnitCellBox.setToolTip(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p>The real space unit cell is typically much larger than the sphere of displayed reflections because the reciprocal unit cell size is inversely proportional to the real space unit cell. Adjust the slider to resize its outline to become compatible with the sphere of displayed reflections.</p></body></html>", None, -1))
