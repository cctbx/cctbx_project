...
#
# Created: Wed Dec 18 18:42:19 2019
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.millerarraytable = QtWidgets.QTableWidget(self.widget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(2)
        sizePolicy.setHeightForWidth(self.millerarraytable.sizePolicy().hasHeightForWidth())
        self.millerarraytable.setSizePolicy(sizePolicy)
        self.millerarraytable.setRowCount(5)
        self.millerarraytable.setColumnCount(10)
        self.millerarraytable.setObjectName("millerarraytable")
        self.millerarraytable.setColumnCount(10)
        self.millerarraytable.setRowCount(5)
        self.gridLayout_5.addWidget(self.millerarraytable, 1, 0, 1, 1)
        ...
        self.SpacegroupLabel.setGeometry(QtCore.QRect(10, 90, 71, 16))
        self.SpacegroupLabel.setObjectName("SpacegroupLabel")
        self.SpaceGroupComboBox = QtWidgets.QComboBox(self.tab)
        self.SpaceGroupComboBox.setGeometry(QtCore.QRect(90, 90, 161, 22))
        self.SpaceGroupComboBox.setObjectName("SpaceGroupComboBox")
        self.expandP1checkbox = QtWidgets.QCheckBox(self.tab)
        self.expandP1checkbox.setGeometry(QtCore.QRect(10, 10, 71, 16))
        self.expandP1checkbox.setObjectName("expandP1checkbox")
        self.expandAnomalouscheckbox = QtWidgets.QCheckBox(self.tab)
        self.expandAnomalouscheckbox.setGeometry(QtCore.QRect(140, 10, 91, 16))
        self.expandAnomalouscheckbox.setObjectName("expandAnomalouscheckbox")
        self.sysabsentcheckbox = QtWidgets.QCheckBox(self.tab)
        self.sysabsentcheckbox.setGeometry(QtCore.QRect(10, 40, 111, 16))
        self.sysabsentcheckbox.setObjectName("sysabsentcheckbox")
        self.missingcheckbox = QtWidgets.QCheckBox(self.tab)
        self.missingcheckbox.setGeometry(QtCore.QRect(140, 40, 111, 16))
        self.missingcheckbox.setObjectName("missingcheckbox")
        self.onlymissingcheckbox = QtWidgets.QCheckBox(self.tab)
        self.onlymissingcheckbox.setGeometry(QtCore.QRect(150, 60, 51, 16))
        ...
        self.clipNormalBtn = QtWidgets.QRadioButton(self.groupBox)
        ...
        self.clipParallelBtn = QtWidgets.QRadioButton(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_19.addWidget(self.frame_2, 0, 0, 1, 2)
        ...
        self.gridLayout_19.addWidget(self.frame_3, 1, 0, 1, 2)
        ...
        self.hkldist_spinBox = QtWidgets.QDoubleSpinBox(self.frame_4)
        self.hkldist_spinBox.setObjectName("hkldist_spinBox")
        self.gridLayout_14.addWidget(self.hkldist_spinBox, 0, 1, 1, 1)
        self.gridLayout_19.addWidget(self.frame_4, 2, 0, 1, 1)
        ...
        self.clipwidth_spinBox = QtWidgets.QDoubleSpinBox(self.frame_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_17.addWidget(self.clipwidth_spinBox, 0, 1, 1, 1)
        self.gridLayout_19.addWidget(self.frame_5, 2, 1, 1, 1)
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(6, 6, 241, 61))
        ...
        self.checkBox_9.setGeometry(QtCore.QRect(10, 20, 171, 16))
        self.checkBox_9.setObjectName("checkBox_9")
        self.checkBox_10 = QtWidgets.QCheckBox(self.groupBox_6)
        self.checkBox_10.setGeometry(QtCore.QRect(10, 40, 171, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QtWidgets.QApplication.translate("MainWindow", "Expansion", None, -1))
        self.showslicecheckbox.setText(QtWidgets.QApplication.translate("MainWindow", "Slice Reflections", None, -1))
        self.groupBox.setTitle(QtWidgets.QApplication.translate("MainWindow", "with a clip plane oriented", None, -1))
        ...
        self.groupBox_2.setTitle(QtWidgets.QApplication.translate("MainWindow", "Vector Components (r1, r2, r3) specified", None, -1))
        ...
        self.label_16.setText(QtWidgets.QApplication.translate("MainWindow", "Angle rotated around vector ", None, -1))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QtWidgets.QApplication.translate("MainWindow", "Slicing", None, -1))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), QtWidgets.QApplication.translate("MainWindow", "Sizing", None, -1))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), QtWidgets.QApplication.translate("MainWindow", "Binning", None, -1))
        self.groupBox_6.setTitle(QtWidgets.QApplication.translate("MainWindow", "Geometry", None, -1))
        self.checkBox_9.setText(QtWidgets.QApplication.translate("MainWindow", "Show reciprocal Unit Cell", None, -1))
        self.checkBox_10.setText(QtWidgets.QApplication.translate("MainWindow", "Show Real Space Unit Cell", None, -1))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_5), QtWidgets.QApplication.translate("MainWindow", "other", None, -1))
