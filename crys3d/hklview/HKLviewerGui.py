...
class Ui_MainWindow(object):
  def setupUi(self, MainWindow):
    ...
    self.millertable.setColumnCount(10)
    self.millertable.setRowCount(0)
    self.millertable.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
    self.millertable.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
