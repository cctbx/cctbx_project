...
#
# Created: Mon Feb 10 17:12:17 2020
...
class Ui_MainWindow(object):
  def setupUi(self, MainWindow):
    ...
    self.gridLayout_20.addWidget(self.ExpandReflsGroupBox, 0, 0, 1, 3)
  ...
  def retranslateUi(self, MainWindow):
    ...
    self.label_7.setText(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p>Tick the &quot;Manual Exponent&quot; box for manually chosing an exponential factor. Untick this box for automatic exponent factor. Automatic exponent factor computes an exponent rendering the reflection with the smalles data value to about 1/10 of the size of the reflection with the largest data value. <br/>Exponent of 1 means the size of a sphere for each reflection is proportional to its data value. This would for a typical data set of amplitudes or intensities render reflections only with very large values visible. Exponent of 0 means all spheres will have the same size irrespective of their data values. So even the weakest reflections will be visible.</p></body></html>", None, -1))
    self.ManualPowerScalecheckbox.setText(QtWidgets.QApplication.translate("MainWindow", "Manual Exponent", None, -1))
