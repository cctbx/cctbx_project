...
"""
# HKLviewerGui.py should be generated from the Qtdesigner output file, HKLviewer3.ui, with the commandline:

"C:\\Program Files\\Python38\\Lib\\site-packages\\PySide2\\uic.exe" HKLviewer3.ui -o HKLviewerGui.py -g python

# Replace the autogenerated imports in HKLviewerGui.py with:

from __future__ import absolute_import, division, print_function  # implicit import
