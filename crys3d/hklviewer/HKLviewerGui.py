...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.zoneH = QPushButton(self.tab_6)
        self.zoneH.setObjectName(u"zoneH")
        self.zoneH.setGeometry(QRect(25, 30, 75, 23))
        self.zoneH.setCheckable(True)
        self.zoneH.setAutoExclusive(True)
        self.zoneH.setAutoDefault(False)
        self.zoneH.setFlat(False)
        self.pushButton = QPushButton(self.tab_6)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(25, 65, 75, 23))
        ...
        self.pushButton_2.setGeometry(QRect(25, 100, 75, 23))
        ...
        self.pushButton_3.setGeometry(QRect(125, 65, 75, 23))
        self.pushButton_3.setCheckable(True)
        self.pushButton_3.setAutoExclusive(True)
        self.pushButton_3.setAutoDefault(False)
        self.pushButton_3.setFlat(False)
        self.zoneH_2 = QPushButton(self.tab_6)
        self.zoneH_2.setObjectName(u"zoneH_2")
        self.zoneH_2.setGeometry(QRect(125, 30, 75, 23))
        self.zoneH_2.setCheckable(True)
        self.zoneH_2.setAutoExclusive(True)
        self.zoneH_2.setAutoDefault(False)
        self.zoneH_2.setFlat(False)
        self.pushButton_4 = QPushButton(self.tab_6)
        self.pushButton_4.setObjectName(u"pushButton_4")
        self.pushButton_4.setGeometry(QRect(125, 100, 75, 23))
        ...
        self.pushButton_5.setGeometry(QRect(25, 150, 75, 23))
        ...
        self.pushButton_6.setGeometry(QRect(25, 185, 141, 23))
        ...
        self.splitter = QSplitter(self.tab_7)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 467, 392))
        ...
        sizePolicy7.setHeightForWidth(self.SpaceGroupComboBox.sizePolicy().hasHeightForWidth())
        self.SpaceGroupComboBox.setSizePolicy(sizePolicy7)
        ...
        sizePolicy8.setHeightForWidth(self.ExpandReflsGroupBox.sizePolicy().hasHeightForWidth())
        self.ExpandReflsGroupBox.setSizePolicy(sizePolicy8)
        ...
        sizePolicy14.setHeightForWidth(self.hkldist_spinBox.sizePolicy().hasHeightForWidth())
        self.hkldist_spinBox.setSizePolicy(sizePolicy14)
        ...
        sizePolicy15.setHeightForWidth(self.label_21.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy14.setHeightForWidth(self.clipwidth_spinBox.sizePolicy().hasHeightForWidth())
        self.clipwidth_spinBox.setSizePolicy(sizePolicy14)
        ...
        sizePolicy8.setHeightForWidth(self.groupBox_5.sizePolicy().hasHeightForWidth())
        self.groupBox_5.setSizePolicy(sizePolicy8)
        ...
        sizePolicy26 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
        sizePolicy26.setHorizontalStretch(0)
        sizePolicy26.setVerticalStretch(0)
        sizePolicy26.setHeightForWidth(self.label_2.sizePolicy().hasHeightForWidth())
        self.label_2.setSizePolicy(sizePolicy26)
        ...
        sizePolicy27 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        sizePolicy27.setHorizontalStretch(0)
        sizePolicy27.setVerticalStretch(0)
        sizePolicy27.setHeightForWidth(self.reciprocunitcellslider.sizePolicy().hasHeightForWidth())
        self.reciprocunitcellslider.setSizePolicy(sizePolicy27)
        ...
        sizePolicy4.setHeightForWidth(self.textInfo.sizePolicy().hasHeightForWidth())
        self.textInfo.setSizePolicy(sizePolicy4)
        font1 = QFont()
        ...
        self.BrowserBox = QWebEngineView(self.splitter_3)
        self.BrowserBox.setObjectName(u"BrowserBox")
        sizePolicy28 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)
        sizePolicy28.setHorizontalStretch(3)
        sizePolicy28.setVerticalStretch(0)
        sizePolicy28.setHeightForWidth(self.BrowserBox.sizePolicy().hasHeightForWidth())
        self.BrowserBox.setSizePolicy(sizePolicy28)
        self.splitter_3.addWidget(self.BrowserBox)
        ...
        self.zoneH.setDefault(False)
        self.pushButton.setDefault(False)
        self.pushButton_2.setDefault(False)
        self.pushButton_3.setDefault(False)
        self.zoneH_2.setDefault(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.zoneH.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Show zones of intensity reflections for H=0. To step through zones of different H values go to the slicing tab under the details tab and change the \"distance from origin\" spin button value accordingly.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.zoneH.setText(QCoreApplication.translate("MainWindow", u"H - I", None))
#if QT_CONFIG(tooltip)
        self.pushButton.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Show zones of intensity reflections for K=0. To step through zones of different H values go to the slicing tab under the details tab and change the \"distance from origin\" spin button value accordingly.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"K - I", None))
#if QT_CONFIG(tooltip)
        self.pushButton_2.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Show zones of intensity reflections for L=0. To step through zones of different H values go to the slicing tab under the details tab and change the \"distance from origin spin\" button value accordingly.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_2.setText(QCoreApplication.translate("MainWindow", u"L - I", None))
#if QT_CONFIG(tooltip)
        self.pushButton_3.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Show zones of I/SigI reflections for K=0. To step through zones of different H values go to the slicing tab under the details tab and change the \"distance from origin\" spin button value accordingly.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_3.setText(QCoreApplication.translate("MainWindow", u"K - I/SigI", None))
#if QT_CONFIG(tooltip)
        self.zoneH_2.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Show zones of I/SigI reflections for H=0. To step through zones of different H values go to the slicing tab under the details tab and change the \"distance from origin\" spin button value accordingly.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.zoneH_2.setText(QCoreApplication.translate("MainWindow", u"H - I/SigI", None))
#if QT_CONFIG(tooltip)
        self.pushButton_4.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Show zones of I/SigI reflections for L=0. To step through zones of different H values go to the slicing tab under the details tab and change the \"distance from origin\" spin button value accordingly.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_4.setText(QCoreApplication.translate("MainWindow", u"L - I/SigI", None))
#if QT_CONFIG(tooltip)
        self.pushButton_5.setToolTip(QCoreApplication.translate("MainWindow", u"Highlight any missing reflections for the sphere of reflections", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_5.setText(QCoreApplication.translate("MainWindow", u"Completeness", None))
#if QT_CONFIG(tooltip)
        self.pushButton_6.setToolTip(QCoreApplication.translate("MainWindow", u"Show reflections coloured by information", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_6.setText(QCoreApplication.translate("MainWindow", u"Information > 0.01 bits", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_6), QCoreApplication.translate("MainWindow", u"Summary", None))
