...
_refln.F_calc
_refln.phase_calc
1 1 1    0    0    6 o   1055.8   38.2     1482.3     7.0
...
1 1 1    0    0    6  o    0.28   -1.43    0.00    0.00
1 1 1    0    0   12  o    0.02    0.24    0.00    0.00
...
_refln.pdbx_FWT
_refln.fom
1 1 1    0    0    6  o   41.29 1238.431  0.99
...
33 Miller arrays in this dataset:
       Type      |   λ/Å   |  #HKLs  |     min,max data       |   d_min,d_max/Å      |     unit cell (a/Å, b/Å, c/Å, α%s, β%s, γ%s)      |   space group      |Anomalous|Data compl.|
         Integer |0.918401 |      15 |        1.0,         1.0|      1.25,      8.352| 79.322, 79.322, 50.113,     90,     90,    120 |     P 61 (No. 169) |   False |0.00030332 |
         Integer |0.918401 |      15 |        1.0,         1.0|      1.25,      8.352| 79.322, 79.322, 50.113,     90,     90,    120 |     P 61 (No. 169) |   False |0.00030332 |
         Integer |0.918401 |      15 |        1.0,         1.0|      1.25,      8.352| 79.322, 79.322, 50.113,     90,     90,    120 |     P 61 (No. 169) |   False |0.00030332 |
          String |0.918401 |      15 |        nan,         nan|      1.25,      8.352| 79.322, 79.322, 50.113,     90,     90,    120 |     P 61 (No. 169) |   False |0.00030332 |
       Amplitude |0.918401 |      14 |       15.6,      1055.8|      1.25,      8.352| 79.322, 79.322, 50.113,     90,     90,    120 |     P 61 (No. 169) |   False | 0.0002831 |
      Map coeffs |0.918401 |      15 |       16.9,      1790.1|      1.25,      8.352| 79.322, 79.322, 50.113,     90,     90,    120 |     P 61 (No. 169) |   False |0.00030332 |
         Integer |0.918401 |      18 |        1.0,         1.0|      1.25,     25.056| 79.322, 79.322, 50.113,     90,     90,    120 |                  ? |       ? |       nan |
         Integer |0.918401 |      18 |        1.0,         1.0|      1.25,     25.056| 79.322, 79.322, 50.113,     90,     90,    120 |                  ? |       ? |       nan |
         Integer |0.918401 |      18 |        1.0,         1.0|      1.25,     25.056| 79.322, 79.322, 50.113,     90,     90,    120 |                  ? |       ? |       nan |
          String |0.918401 |      18 |        nan,         nan|      1.25,     25.056| 79.322, 79.322, 50.113,     90,     90,    120 |                  ? |       ? |       nan |
       Intensity |0.918401 |      18 |     -105.2,      1176.5|      1.25,     25.056| 79.322, 79.322, 50.113,     90,     90,    120 |                  ? |       ? |       nan |
         Integer |0.979338 |      17 |        1.0,         1.0|      1.25,     25.051| 79.313, 79.313, 50.102,     90,     90,    120 |                  ? |       ? |       nan |
         Integer |0.979338 |      17 |        2.0,         2.0|      1.25,     25.051| 79.313, 79.313, 50.102,     90,     90,    120 |                  ? |       ? |       nan |
         Integer |0.979338 |      17 |        1.0,         1.0|      1.25,     25.051| 79.313, 79.313, 50.102,     90,     90,    120 |                  ? |       ? |       nan |
          String |0.979338 |      17 |        nan,         nan|      1.25,     25.051| 79.313, 79.313, 50.102,     90,     90,    120 |                  ? |       ? |       nan |
       Intensity |0.979338 |      17 |      -44.3,  2.4913e+04|      1.25,     25.051| 79.313, 79.313, 50.102,     90,     90,    120 |                  ? |       ? |       nan |
         Integer |0.979108 |      19 |        1.0,         1.0|     1.361,     25.081|   79.4,   79.4, 50.162,     90,     90,    120 |                  ? |       ? |       nan |
         Integer |0.979108 |      19 |        3.0,         3.0|     1.361,     25.081|   79.4,   79.4, 50.162,     90,     90,    120 |                  ? |       ? |       nan |
         Integer |0.979108 |      19 |        1.0,         1.0|     1.361,     25.081|   79.4,   79.4, 50.162,     90,     90,    120 |                  ? |       ? |       nan |
          String |0.979108 |      19 |        nan,         nan|     1.361,     25.081|   79.4,   79.4, 50.162,     90,     90,    120 |                  ? |       ? |       nan |
       Intensity |0.979108 |      19 |    -1052.0,      8401.4|     1.361,     25.081|   79.4,   79.4, 50.162,     90,     90,    120 |                  ? |       ? |       nan |
         Integer |0.918401 |      20 |        1.0,         1.0|      1.25,     68.687| 79.313, 79.313, 50.103,     90,     90,    120 |                  ? |       ? |       nan |
         Integer |0.918401 |      20 |        1.0,         1.0|      1.25,     68.687| 79.313, 79.313, 50.103,     90,     90,    120 |                  ? |       ? |       nan |
         Integer |0.918401 |      20 |        1.0,         1.0|      1.25,     68.687| 79.313, 79.313, 50.103,     90,     90,    120 |                  ? |       ? |       nan |
          String |0.918401 |      20 |        nan,         nan|      1.25,     68.687| 79.313, 79.313, 50.103,     90,     90,    120 |                  ? |       ? |       nan |
       HL coeffs |0.918401 |      18 |      -1.87,      166.29|      1.25,       8.35| 79.313, 79.313, 50.103,     90,     90,    120 |                  ? |       ? |       nan |
         Integer |0.918401 |      18 |        1.0,         1.0|      1.25,       8.35| 79.313, 79.313, 50.103,     90,     90,    120 |                  ? |       ? |       nan |
         Integer |0.918401 |      18 |        1.0,         1.0|      1.25,       8.35| 79.313, 79.313, 50.103,     90,     90,    120 |                  ? |       ? |       nan |
         Integer |0.918401 |      18 |        1.0,         1.0|      1.25,       8.35| 79.313, 79.313, 50.103,     90,     90,    120 |                  ? |       ? |       nan |
          String |0.918401 |      18 |        nan,         nan|      1.25,       8.35| 79.313, 79.313, 50.103,     90,     90,    120 |                  ? |       ? |       nan |
  Floating-point |0.918401 |      18 |    -168.56,       180.0|      1.25,       8.35| 79.313, 79.313, 50.103,     90,     90,    120 |                  ? |       ? |       nan |
  Floating-point |0.918401 |      18 |      4.164,      1995.8|      1.25,       8.35| 79.313, 79.313, 50.103,     90,     90,    120 |                  ? |       ? |       nan |
  Floating-point |0.918401 |      18 |       0.15,         1.0|      1.25,       8.35| 79.313, 79.313, 50.103,     90,     90,    120 |                  ? |       ? |       nan |
...
===============================================================================
1 Miller arrays in this dataset:
 Labels          |       Type      |  #HKLs  |     min,max data       |     min,max sigmas     |   d_min,d_max/Å      |   space group      |Anomalous|Data compl.|Ano.complete|#Bijvoets|#Singletons|
I(+),SIGI(+),I(-),SIGI(-)
                 |       Intensity |      57 |      -11.8,  2.9405e+04|        0.4,      2926.8|     2.293,     43.002|   R 3 :R (No. 146) |    True | 0.0059511 |  0.0052203 |      25 |         7 |
