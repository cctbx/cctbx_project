...
class ProfileModelFactory(object):
  ...
  def from_dict(obj):
    ...
    logging.getLogger('dxtbx.model.profile').warn('No profile class %s registered' % obj['__id__'])
    print('dxtbx.model.profile: WARNING: No profile class %s registered' % obj['__id__'])
    return None
