...
def show_registry(filename = None):
  ...
  print ("Showing hierarchy of classes in the dxtbx registry%s. The root classes are shown with depth of 1, and subclasses are shown indented and with a higher depth number."%extrabit)
  print ()
  print ("Depth  Class name")
  print ("    0  Format")

  for classobj in Registry._formats: print_class(classobj, filename)
