...
#
# LIBTBX_SET_DISPATCHER_NAME cctbx.xfel.submit_job
#
...
help_str = """
Use cctbx.xfel.submit_job to submit a cctbx.xfel job to a cluster for analyzing
diffraction data.  cctbx.xfel.submit_job will create a directory for
...
cctbx.xfel.submit_job input.cfg=cxi49812/thermo.cfg input.experiment=cxi49812 \\
...
cctbx.xfel.submit_job submit.phil
...
cctbx.xfel.submit_job /path/to/h5/runs/directory/266708-0/run*.h5 \\
