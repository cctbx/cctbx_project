...
from xfel.merging.application.errors.error_modifier_ev11_mll import error_modifier_ev11_mll
...
class factory(factory_base):
  ...
  def from_parameters(params, additional_info=[], mpi_helper=None, mpi_logger=None):
    ...
    if additional_info[0] == "premerge":
      ...
      elif params.merging.error.model == "ev11_mll":
        return [error_modifier_ev11_mll(params, mpi_helper, mpi_logger)]
    return []
