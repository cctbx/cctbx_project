...
xpp_active_areas = {
  'XPP 1.2.1': { # metrology recorded 1/24/13 and processed by flatfile.py
  ...
  'XPP 1.2.2': { # metrology recorded 1/29/13 and processed by flatfile.py
    'active_areas': flex.int([
          ...
          1103,  310, 1297,  495,  906,  310, 1100,  495,
           ...
           707,   38,  892,  232,  707,  235,  892,  429,
            ...
            10,  466,  495,  660,  310,  663,  495,  857,
