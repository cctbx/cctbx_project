...
def selection_string_from_selection(pdb_hierarchy_inp,
  ...
  Args:
    ...
    exclude_water (bool): selection without water
  ...
  if not chains_info:
    chains_info = ncs_search.get_chains_info(
      pdb_hierarchy_inp,exclude_water=exclude_water)
  ...
  for ch_id in chain_ids:
    ...
    if exclude_water and (len(a_sel) != chains_info[ch_id].chains_atom_number):
