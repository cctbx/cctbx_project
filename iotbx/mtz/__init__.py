...
ext = boost_adaptbx.python.import_ext("iotbx_mtz_ext")
...
os.name: %s
sys.platform: %s
boost_adaptbx.python.platform_info: %s
...
""" % (
  ...
  os.name,
  sys.platform,
  boost_adaptbx.python.platform_info))
...
@boost_adaptbx.python.inject_into(ext.object)
class _():
...
@boost_adaptbx.python.inject_into(ext.crystal)
class _():
...
@boost_adaptbx.python.inject_into(ext.dataset)
class _():
...
@boost_adaptbx.python.inject_into(ext.column)
class _():
...
@boost_adaptbx.python.inject_into(ext.batch)
class _():
