...
ext = boost_adaptbx.python.import_ext("iotbx_ccp4_map_ext")
...
boost_adaptbx.python.inject(ext.map_reader, utils) # A way to access these
@boost_adaptbx.python.inject_into(ext.map_reader) # A way to access these
class _():
