...
class MolDataFrame:
  ...
  def add_restraints_from_dataframes(self,restraints_data):
    self.bonds = restraints_data.bond
    self.angles = restraints_data.angle
    self.dihedrals = restraints_data.dihedral
    self.chirals = restraints_data.chirality
