...
class RestraintsEntryView(ScrollEntryView):
  def __init__(self,parent=None):
    super().__init__(parent=parent)


class RestraintsListView(ScrollableListView):
  def __init__(self,parent=None):
        super().__init__(parent=parent)
...
class RestraintsTab(GUITab):
  def __init__(self,parent=None,title="Restraint"):
    ...
    self.process_button.setToolTip("Process the active model to generate restraints")
