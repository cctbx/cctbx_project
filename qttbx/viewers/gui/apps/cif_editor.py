...
from ..view.apps.cif_editor import CifEditorGUIView
from ..controller.apps.cif_editor import CifEditorGUIController
...
def main(dm=None,params=None,log=None):
  ...
  state = State(dm)
  view = CifEditorGUIView(params=params)
  controller = CifEditorGUIController(parent=state,view=view,params=params)
  app = CifEditorGUIApp(state,view,controller)
  ...
  if hasattr(app.view,"python_console"):
