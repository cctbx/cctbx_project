...
class MainApp(wx.App):
  ...
  def workaround(self):
    ...
    when any PRIME module is imported; numpy has to be imported prior to any
    PRIME module; this function calls numpy to avoid the "unused import"
    error. Someday we will fix this. '''
