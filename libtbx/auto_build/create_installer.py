...
class SetupInstaller(object):
  ...
  def copy_modules(self):
    ...
    if os.path.isfile(self.revisionnumbers):
      copyfile(os.path.join(self.root_dir, 'modules', 'RevisionNumbers.txt'),
       os.path.join(self.dest_dir, 'modules', 'RevisionNumbers.txt'))
