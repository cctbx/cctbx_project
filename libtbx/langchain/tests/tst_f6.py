"""
Unit tests for F6 stop-feedback fix (v115, 2026-03-10).

F6: Terminal diagnosis — ensure DisplayDataModel sees a "stop_reason"
    of "diagnosed_failure" in session.data so the Results tab can show
    the ⚠ Agent Stopped indicator.
