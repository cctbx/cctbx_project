"""
Follow-up tests: abort_message for no_workflow_state and after_program_not_available.
These stops were previously silent (no abort_message at state top-level).
"""
import sys
import os
