"""
Unit tests for F5 stop-feedback fix (v115, 2026-03-10).

F5: Rules-only success — use stop_reason='workflow_complete' when the
    workflow engine reaches the 'complete' step so the Results tab can
    show a success message instead of "No valid programs available".
