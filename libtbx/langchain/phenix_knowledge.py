...
INVALID_FILENAMES = {
    "input.pdb", "model.pdb", "search_model.pdb", "my_model.pdb",
    "sequence.seq", "seq.dat", "protein.seq",
    "data.mtz", "reflections.mtz", "input.mtz", "output.mtz"
}
...
KNOWN_ISSUES = {
    ...
    "Ambiguous parameter definition": "ACTION: The log lists 'Best matches'. You MUST choose one of the full paths listed (e.g. `xray_data...` for X-ray). Do not use the short name.",
