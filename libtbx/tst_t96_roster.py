...
#
# Fixtures are synthetic text built here: no log file, no network.  Runs
# offline in well under a second under libtbx.python; the parser under test
# is imported as libtbx.test_utils.t96_roster, so libtbx must be importable.
#
# This is the registered test of libtbx/test_utils/t96_roster.py, listed in
# libtbx/run_tests.py.

from __future__ import absolute_import, division, print_function

from libtbx.test_utils import t96_roster
