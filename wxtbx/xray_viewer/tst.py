...
def exercise_1 () :
  ...
  assert (p.get_bitmap_params() == (0, 0, 2048, 1536))
  p.set_zoom(1.0)
  assert (p.get_bitmap_params() == (0, 0, 1024, 768))
  p.translate_image(-800, -800)
  assert (p.get_bitmap_params() == (800, 800, 1024, 768))
  p.translate_image(-400, -400)
  assert (p.get_bitmap_params() == (1024, 1200, 1024, 768))
  assert (p.get_thumbnail_box() == (128, 150, 128, 96))
