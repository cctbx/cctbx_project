...
def test_3():
   ...
   assert(flex.max(f_star) ,          2505.77677201 , 1.e-4)
   assert(flex.min(f_star) ,          0.0           , 1.e-4)
   assert(flex.mean(f_star),          1085.99060715 , 1.e-4)
   assert(flex.max(w_star) ,          1.0           , 1.e-4)
   assert(flex.min(w_star) ,          0.0           , 1.e-4)
   assert(flex.mean(w_star),          0.01782658613 , 1.e-4)
   assert(flex.max(mu)     ,          2.23810354633 , 1.e-4)
   assert(flex.min(mu)     ,          0.0           , 1.e-4)
   assert(flex.mean(mu)    ,          1.20159615933 , 1.e-4)
   assert(flex.max(nu)     ,          0.999107484116, 1.e-4)
   assert(flex.min(nu)     ,          0.0           , 1.e-4)
   assert(flex.mean(nu)    ,          0.745699513719, 1.e-4)
   assert(nzero            ,          501           )
...
def test_4():
   ...
   per = obj.phase_error()
   fom = obj.fom()
   assert(flex.max(per) ,  89.9325000127     , 1.e-4)
   assert(flex.min(per) ,  5.37565067746e-05 , 1.e-4)
   assert(flex.mean(per),  20.7942460698     , 1.e-4)
   assert(flex.max(fom) ,  0.999999402705    , 1.e-4)
   assert(flex.min(fom) ,  0.000749999859375 , 1.e-4)
   assert(flex.mean(fom),  0.858269037582    , 1.e-4)
