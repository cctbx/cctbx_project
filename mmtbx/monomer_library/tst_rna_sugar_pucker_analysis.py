...
def exercise(args):
  ...
  analysis = rna_sugar_pucker_analysis.evaluate(
    ...
    residue_1_deoxy_ribo_atom_dict=atom_dict([
      (21.101,30.048,33.325), (22.184,28.704,36.539), (21.527,28.782,35.281),
      (22.379,28.287,34.119), (22.676,26.795,34.032)]),
    residue_1_c1_n_closest_atom=atom((19.628,30.157,32.953)),
  ...
  analysis = rna_sugar_pucker_analysis.evaluate(
    ...
    residue_1_c1_n_closest_atom=atom((50.926,10.084,37.569)),
  ...
  analysis = rna_sugar_pucker_analysis.evaluate(
    ...
    residue_1_c1_n_closest_atom=atom((41.433,12.332,31.466)),
