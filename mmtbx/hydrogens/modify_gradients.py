...
def modify_gradients(sites_cart, h_parameterization, grads):
  for hp in h_parameterization:
    ...
    G0 = matrix.col(grads[a0])
    G1 = matrix.col(grads[a1])
    G2 = matrix.col(grads[a2])
    #
    ...
    # step 4
      ...
      #
      grads[a0] = (G0[0] + GH[0] - Gr10[0] - Gr20[0],
                   G0[1] + GH[1] - Gr10[1] - Gr20[1],
                   G0[2] + GH[2] - Gr10[2] - Gr20[2])
      grads[a1] = (G1[0] + Gr10[0],
                   G1[1] + Gr10[1],
                   G1[2] + Gr10[2])
      grads[a2] = (G2[0] + Gr20[0],
                   G2[1] + Gr20[1],
                   G2[2] + Gr20[2])
    #
    if (hp.htype == '3neigbs'):
      a3 = hp.a3
      G3 = matrix.col(grads[a3])
      r1 = matrix.col(sites_cart[a1])
      r2 = matrix.col(sites_cart[a2])
    ...
    # step 3
      ...
      #
      grads[a0] = (G0[0] + GH[0] - Gr10[0] - Gr20[0] - Gr30[0],
    ...
    #
      grads[a0] = (G0[0] + GH[0] + Gr01[0],
                   G0[1] + GH[1] + Gr01[1],
                   G0[2] + GH[2] + Gr01[2])
      grads[a1] = (G1[0] - Gr01[0] - Grb1[0],
                   G1[1] - Gr01[1] - Grb1[1],
                   G1[2] - Gr01[2] - Grb1[2])
      grads[a2] = (G2[0] + Grb1[0],
                   G2[1] + Grb1[1],
                   G2[2] + Grb1[2])
    #
    #self.grads[ih] = (0,0,0)
