...
pdb = """
CRYST1   41.416  118.870  143.506  90.00  90.00  90.00 P 2 21 21
HETATM    1  C24 8ZB C   1     -11.856  33.211  15.894  1.00 30.00           C
HETATM    2  C28 8ZB C   1     -11.887  31.722  16.295  1.00 30.00           C
HETATM    3  C31 8ZB C   1     -10.626  31.074  15.706  1.00 30.00           C
HETATM    4  C36 8ZB C   1     -10.464  29.626  16.001  1.00 30.00           C
HETATM    5  C38 8ZB C   1      -8.548  28.259  15.474  1.00 30.00           C
HETATM    6  C39 8ZB C   1      -8.641  28.457  16.949  1.00 30.00           C
HETATM    7  C40 8ZB C   1      -9.777  29.327  17.279  1.00 30.00           C
HETATM    8  C49 8ZB C   1      -6.943  29.546  14.455  1.00 30.00           C
HETATM    9  C50 8ZB C   1      -6.008  28.069  13.155  1.00 30.00           C
HETATM   10  C51 8ZB C   1      -7.023  27.489  13.934  1.00 30.00           C
HETATM   11  C53 8ZB C   1      -6.638  25.539  13.000  1.00 30.00           C
HETATM   12  C55 8ZB C   1      -5.351  27.242  12.321  1.00 30.00           C
HETATM   13  N47 8ZB C   1      -7.412  28.437  14.617  1.00 30.00           N
HETATM   14  N48 8ZB C   1      -5.966  29.513  13.551  1.00 30.00           N
HETATM   15  N52 8ZB C   1      -7.335  26.248  13.879  1.00 30.00           N
HETATM   16  N54 8ZB C   1      -5.665  25.993  12.237  1.00 30.00           N
HETATM   17  N57 8ZB C   1      -4.287  27.770  11.517  1.00 30.00           N
HETATM   18  O37 8ZB C   1      -9.705  29.010  14.951  1.00 30.00           O
HETATM   19  O41 8ZB C   1      -7.602  28.355  17.894  1.00 30.00           O
HETATM   20  O42 8ZB C   1     -10.593  28.384  17.923  1.00 30.00           O
TER
END
"""

cif = """
# Produced by Grade Web Server http://grade.globalphasing.org
# --------- service provided by Global Phasing Ltd. ---------
#
# GEN: Generated by GRADE_PDB_LIGAND 1.2.13 (August 12 2017)
# GEN: using MOGUL 1.7.4(168223), CSD as539be, with quantum mechanics RM1
# GEN: ((DatabaseID PDB-8ZB))
# Compound InChI BKDAOQOLDUJANJ-WOUKDFQISA-N
# Compound full name _2__R_,3__R_,4__S_,5__R__-2-_6-aminopurin-9-yl_-5-propyl-oxolane-3,4-diol
#
# Number of restraints found:
# Bond lengths
#     lengths/sigmas set by mogul                22
#     bonds to hydrogen set to neutron values    17
#     bonds lengths set by partial QM             0
# Bond Angles
#     angles/sigmas set by mogul                 32
#     non-H angles set by partial QM              0
#     H bond angles set by partial QM            37
...
#     trigonal atoms from partial QM              3
#     atoms not trigonal from partial QM          0
# Torsions and 1-4 planes
#     bonds where mogul states cis/trans          2
#     bonds mogul indicates flat                  0
#     bonds mogul indicates 3-fold staggered      2
#     bonds mogul indicates not flat              0
#     in flat 5/6 membered rings after PQM       11
#     other flat bonds after partial QM           1
#     sp3-sp3 set 3-fold staggered by QM          0
#     All other torsions (unrestrained)           9
