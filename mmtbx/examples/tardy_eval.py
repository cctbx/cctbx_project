...
from mmtbx.refinement import tardy_comprehensive_test_helper
...
def rmsd_start_final_plots_minimization(
  ...
  for cp_i_trial in xrange(cp_n_trials):
    tardy_comprehensive_test_helper.set_parameters(
      params=p,
...
def eval_1(args):
  ...
  if (algorithm == "minimization"):
    parameter_trial_table \
      = tardy_comprehensive_test_helper.common_parameter_trial_table
  elif (algorithm == "annealing"):
    parameter_trial_table \
      = tardy_comprehensive_test_helper.annealing_parameter_trial_table
  else:
    raise AssertionError
  cp_n_trials = tardy_comprehensive_test_helper.number_of_trials(
