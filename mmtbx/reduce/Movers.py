...
#  - StateReturn FinePositions(coarseIndex)
...
class _MoverRotator:
  ...
  def CoarsePositions(self):
    ...
    return StateReturn(self._atoms,
...
class MoverNH2Flip:
  ...
  def CoarsePositions(self):
    ...
    return StateReturn(self._atoms, self._coarsePositions, [0.0, 0.0])
  ...
  def FixUp(self, coarseIndex):
    ...
    return StateReturn(self._atoms, self._fixUpPositions[coarseIndex], [0]*len(self._atoms))
