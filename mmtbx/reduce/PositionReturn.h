...
namespace molprobity {
  namespace reduce {
    ...
    public:
      ...
      PositionReturn(
        scitbx::af::shared<iotbx::pdb::hierarchy::atom>  p_atoms
        , scitbx::af::shared< scitbx::af::shared<molprobity::probe::Point> >  p_positions
        , scitbx::af::shared< scitbx::af::shared<molprobity::probe::ExtraAtomInfo> > p_extraInfos
        , scitbx::af::shared< scitbx::af::shared<bool> > p_deleteMes
        , scitbx::af::shared<double>  p_preferenceEnergies
      ) : atoms(p_atoms)
