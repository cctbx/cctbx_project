...
def run(args, out=sys.stdout, validated=False):
  ...
  for a1,c1,v1, a2,c2,v2 in zip(h1.arguments(), h1.c_values(), list(h1.values()),
                                h2.arguments(), h2.c_values(), list(h2.values())):
  ...
  results['map_histograms'] = ( (h1.arguments(), h1.c_values(), list(h1.values())),
                                (h2.arguments(), h2.c_values(), list(h2.values())) )
