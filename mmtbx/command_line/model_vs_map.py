...
def run(args, log=sys.stdout):
  ...
  print("  CC_mask  : %6.4f"%five_cc_result.cc_mask, file=log)
  print("  CC_volume: %6.4f"%five_cc_result.cc_volume, file=log)
  print("  CC_peaks : %6.4f"%five_cc_result.cc_peaks, file=log)
