...
class n_z_test (scaling.xtriage_analysis):
  def __init__(self,
    ...
    d_kolmogorov_smirnov_c = max_deviation_c/c_theory[10]*math.sqrt(
      n_z_less_then_one_c  )
    z = flex.double(list(range(11)))/10.0
    self.z = z
    self.ac_obs = ac_obs
...
class l_test (scaling.xtriage_analysis):
  ...
  def __init__(self,
    ...
    self.l_values = flex.double(list(range(self.l_cumul.size())))/float(
      self.l_cumul.size())
...
class britton_test (scaling.xtriage_analysis):
  def __init__(self,
    ...
    if not miller_array.is_xray_intensity_array():
      miller_array = miller_array.f_as_f_sq()
    britton_plot_array = []
    britton_plot_alpha = flex.double(list(range(50)))/101.0
    ...
    while not_done:
      ...
      for ii in range(48):
        alpha = ii/101.0
        britton_range = (flex.double(list(range(ii,50))))/101.0
