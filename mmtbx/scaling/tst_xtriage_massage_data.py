...
def exercise_twin_detwin () :
  ...
  xtriage.run(
    args=[
      ...
      "twin_law='l,-k,h'",
      "fraction=0.3",
      "hklout=tmp_xtriage_twinned.mtz",
    ],
    out=null_out())
  assert op.isfile("tmp_xtriage_twinned.mtz")
  mtz_in = file_reader.any_file("tmp_xtriage_twinned.mtz")
  ...
  xtriage.run(
    args=[
      ...
      "twin_law='l,-k,h'",
      "fraction=0.3",
      "hklout=tmp_xtriage_detwinned.mtz",
    ],
    out=null_out())
  mtz_in = file_reader.any_file("tmp_xtriage_detwinned.mtz")
