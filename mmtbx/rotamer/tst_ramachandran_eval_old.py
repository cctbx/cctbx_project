...
#
# !!! Oleg on 11-19-2015. This test was extracted from ramachandran_eval.py
# because tests should be separated from code in the first place.
# It fails and not run in t48 probably because it uses old databases.
# I'm leaving it in a separate file in case somebody would like to fix it.
#
