...
def exercise_1():
  ...
  print find_region_max_value(RAMA_GENERAL, -120, -179) == ((-115.0, 131.0), 0.57068)
  ...
  print find_region_max_value(RAMA_GENERAL, 60, 60) # wrong here
  ...
  print find_region_max_value(RAMA_GENERAL, 53, -130) # wrong here

  print "=================================================="
  # ((-63.0, -41.0), 1.0)
  assert find_region_max_value(RAMA_GLYCINE, -80, -20) == ((-63.0, -41.0), 1.0)
  print find_region_max_value(RAMA_GLYCINE, -80, 60) # wrong here
  print find_region_max_value(RAMA_GLYCINE, -80, 65) # wrong here
  # ((63.0, 41.0), 1.0)
  ...
  print find_region_max_value(RAMA_GLYCINE, 120, 160) # wrong
  print find_region_max_value(RAMA_GLYCINE, -100, 140) # wrong
  print find_region_max_value(RAMA_GLYCINE, -100, -160) # wrong
  ...
  print find_region_max_value(RAMA_CISPRO, -80, -178) # wrong
  ...
  print find_region_max_value(RAMA_TRANSPRO, -80, -179) # wrong

  print "=================================================="
  # ((-70.1, 149.0), 0.9619998)
  assert find_region_max_value(RAMA_PREPRO, -120, 140) == ((-70.1, 149.0), 0.9619998)
  print find_region_max_value(RAMA_PREPRO, -120, 60) # wrong
  print find_region_max_value(RAMA_PREPRO, -160, 80) # wrong
  print find_region_max_value(RAMA_PREPRO, -160, 160) # wrong?
  # ((-57.0, -45.0), 1.0)
  ...
  print find_region_max_value(RAMA_PREPRO, 60, 60) # wrong
  print find_region_max_value(RAMA_PREPRO, 55, 55) # wrong
  ...
  print find_region_max_value(RAMA_ILE_VAL, -130, -179) # wrong
